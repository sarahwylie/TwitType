//package com.cooksys.TwitThis;
//
//import com.cooksys.TwitThis.entities.*;
...
//	/*
//
//		REMEMBER TO COMMENT OUT SEEDER WHENEVER YOU RUN YOUR POSTMAN TESTS
//
//	 */
...
//        tweet1.setUserMentioned(Arrays.asList(user1, user2));
...
//        tweet5.setUserMentioned(Arrays.asList(user1, user2));
...
//        // Set Content @PARAM String
//        tweet6.setContent("This is some content 6 tweet6");
//        tweet6.setRepostOf(tweet5);
//        tweet6.setUserMentioned(Arrays.asList(user1, user2));
...
//        deletedTweet.setUserMentioned(Arrays.asList(user1, user2));
